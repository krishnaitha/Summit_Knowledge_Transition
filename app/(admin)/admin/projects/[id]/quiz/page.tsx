    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold text-slate-900">Quest sets</h2>
            ...
            (() => {
              ...
              return (
                <div className="flex flex-col items-end gap-2">
                  <div className="bg-brand-50 text-brand-700 flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium">
        ...
        {sets.length > 0 ? (
          ...
          <div className="rounded-2xl border border-dashed border-slate-200 px-6 py-12 text-center">
            ...
            <p className="mt-3 text-sm text-slate-500">No Quest sets have been created yet.</p>
            <p className="mt-1 text-xs text-slate-400">
              Use the AI generator below or create a set manually.
            </p>
          </div>
        )}
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Create Quest set manually</CardTitle>
        </CardHeader>
        <CardContent>
          <form action={createQuizSetAction} className="grid gap-4 md:grid-cols-4">
            ...
            <SubmitButton className="md:w-fit" loadingText="Creating…">
              Create set
            </SubmitButton>
          </form>
        </CardContent>
