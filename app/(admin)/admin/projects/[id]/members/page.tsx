      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-slate-500">
            Project admins can manage documents, members, and quizzes for this project only. They
            don&apos;t have access to other projects.
          </p>
        </CardHeader>
                ...
                <div className="flex flex-wrap gap-2">
                  <form action={updateProjectMemberRoleAction} className="flex items-center gap-2">
                    ...
                    <input
                      name="role"
                      type="hidden"
                      value={member.project_role === 'admin' ? 'member' : 'admin'}
                    />
