              ...
              <CardContent className="flex flex-col gap-4 p-6 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                    ...
                    className={cn(
                      'focus:ring-accent-400 inline-flex h-11 items-center justify-center rounded-xl px-4 text-sm font-medium transition focus:ring-2 focus:ring-offset-2 focus:outline-none',
                      pendingCount > 0
                        ? 'bg-brand-700 hover:bg-brand-800 text-white'
                        : 'text-brand-700 bg-white ring-1 ring-slate-200 hover:bg-slate-50',
                    )}
                  >
